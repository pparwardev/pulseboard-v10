...
export default function RegisterPageNew() {
  ...
  const validateForm = () => {
    ...
    if (!formData.team_name) { toast.error('Please select a team'); return false; }
    return true;
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/api/auth/register', {
        ...
        manager_login: formData.manager_login,
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <select name="team_name" value={formData.team_name} onChange={handleChange} required className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500">
                  <option value="">Select Team</option>
                  <option value="LESC">SPS Account Manager [LESC]</option>
                </select>
              </div>
            </div>
