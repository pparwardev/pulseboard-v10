...
def register(user_data: UserCreate, db: Session = Depends(get_db)):
    ...
    tm = TeamMember(employee_id=user.employee_id, name=user.name, email=user.email, user_id=user.id, role=user.role, is_active=True)
    db.add(tm)
    db.commit()
    ...
    from app.utils.email_helper import verify_ses_email
    verify_ses_email(user.email)
